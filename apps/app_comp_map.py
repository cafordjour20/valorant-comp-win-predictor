...
st.caption("⚠️ This model achieved only ~46% accuracy in testing — barely above random guessing. Predictions here are illustrative, not confident forecasts of match outcomes.")
